...
C++ est un langage compilé. C'est à dire qu'il doit être compilé par un compilateur avant de pouvoir être roulé.
...
Une fonction C++ peut être codée dans un script C++ en tenant compte de la syntaxe spécifique à _Rcpp_. Le script C++ n'a qu'à être référencé dans le code R, comme on le ferait pour un script R.
```{r}
